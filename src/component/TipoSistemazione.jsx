...
const TipoSistemazione = () => {
  ...
  const handleSwitchChangeSelected = (nomeSistemazione) => {
    if (selezionate.includes(nomeSistemazione)) {
      setSelezionate(selezionate.filter((item) => item !== nomeSistemazione));
    } else {
      setSelezionate([nomeSistemazione]);
    }
  };
              ...
              <tr key={elem.id}>
                ...
                <td>
                  <Form.Check
                    ...
                    id={`switch-${elem.id}`}
                    label="seleziona"
                    onChange={() => handleSwitchChangeSelected(elem.nomeSistemazione)}
                    checked={selezionate.includes(elem.nomeSistemazione)}
                  />
                </td>
              </tr>
            ))}
